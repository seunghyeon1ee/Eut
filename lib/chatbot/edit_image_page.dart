...
class _EditImagePageState extends State<EditImagePage> {
  ...
  void startRecording() async {
    ...
    _recordingFilePath = '${tempDir.path}/recording_${DateTime.now().millisecondsSinceEpoch}.aac';
  ...
  void stopRecording() async {
    ...
    provider.setRecordingFilePath(_recordingFilePath);
    ...
    if (_name.isNotEmpty && provider.recordingFilePath != null) {
      try {
        final request = http.MultipartRequest(
          'POST',
          Uri.parse('http://3.38.165.93:8080/api/v1/character/${widget.imageItems[provider.currentIndex].characterId}'), // API URL
        );
            ...
            children: [
              Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Color(0xFFEC295D).withOpacity(0.3),
                      spreadRadius: 2,
                      blurRadius: 5,
                      offset: Offset(0, 2),
                    ),

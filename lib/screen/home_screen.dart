              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text('환영합니다!',
                      style: TextStyle(color: Colors.black, fontSize: 24, fontFamily: 'Noto Sans', fontWeight: FontWeight.w600, height: 0.06),
                    ),
                  ],
                ),
                Row(
              ...
              children: [
                  ...
                  child: Center(
                      child: Ink(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            gradient:
                            LinearGradient(colors: [Color(0xFFEC295D), Color(0xFFFF7672)])),
                        child: Center(
                          child: Text('시작하기', style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'Noto Sans', fontWeight: FontWeight.w600, height: 0.07),
                          ),
                        ),
                      )
                  ),
                ...
                Center(
                  child: OutlinedButton(
                    ...
                    child: Text('가족으로 시작하기', style: TextStyle(
                        color: Color(0xFF4D4D4D), fontSize: 14, fontFamily: 'Noto Sans', fontWeight: FontWeight.w400, height: 0.09),
                    ),
                  ),
                ),
                SizedBox(height: 60),

                              ...
                              if (smsCode.isNotEmpty &&
                                ...
                                try {
                                  firebase_auth.PhoneAuthCredential credential =
                                      firebase_auth.PhoneAuthProvider
                                          .credential(
...
// todo: gpt-4 돌려서 authprovider 나온결과 밑에 주석처리 해두겠음. 구현을 하고 싶은데  authentication_screen.dart랑 선언한게 달라서 충돌남
// todo: 여기는 provider 설정하는 걸 안하는 게 나을듯
//
// import 'dart:async';
// import 'dart:convert';
// import 'dart:io';
...
// import 'package:taba_app_proj/chatbot/chat_test.dart';
// import 'package:taba_app_proj/screen/home_screen.dart';
// import '../provider/auth_provider.dart'; // AuthProvider 추가
//
// class MyApp2 extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
...
//     authProvider.verifyPhoneNumber(context, '+82${_controller.text}', (verificationId) {
//       startTimer();
//       setState(() {
//         _isTextFieldVisible = true;
//       });
...
//                           final authProvider = Provider.of<AuthProvider>(context, listen: false);
//                           try {
//                             final user = await authProvider.signInWithSmsCode(smsCode);
//                             if (user != null) {
//                               ScaffoldMessenger.of(context)
...
//                                 break;
//                               case "invalid-verification-id":
//                                 errorMessage = 'verification ID of the credential is not valid.';
//                                 break;
//                               case "missing-verification-id":

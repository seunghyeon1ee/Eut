...
class _TextInputButtonState extends State<TextInputButton> {
  ...
  void _updateButtonState() {
    ...
    setState(() {
      _isButtonEnabled =
          isRegisterFilled && isNumberFilled; // 두 필드 모두 채워져 있는지 확인
      if (_isButtonEnabled) {
        _nextButtonColor = Color(0xFFEC295D);
        _nextTextColor = Colors.white;
      } else {
  ...
  Widget _buildTextField(
      TextEditingController textFieldcontroller, String label) {
    return Container(
      width: 350,
      height: 52,
      child: TextField(
